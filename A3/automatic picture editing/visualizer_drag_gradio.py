...
with gr.Blocks() as app:
            ...
            with gr.Column(scale=3):
                ...
                with gr.Row():
                    ...
                    with gr.Column(scale=4, min_width=10):
                        ...
                        with gr.Row():
                            with gr.Column(scale=1, min_width=10):
                                big_eye = gr.Button("Big eye")
                            with gr.Column(scale=1, min_width=10):
                                closed_eye = gr.Button("Closed eye")
    ...
    def on_click_smile(global_state):
        ...
        points[point_idx + 1] = {'start': [int(preds[57,0]), int(preds[57,1])],\
         'target': [int(preds[57,0]), int(preds[57,1])+15]}
        points[point_idx + 2] = {'start': [int(preds[60,0]), int(preds[60,1])],\
         'target': [int(preds[60,0])-10, int(preds[60,1])-10]}
        points[point_idx + 3] = {'start': [int(preds[64,0]), int(preds[64,1])],\
    ...
    def on_click_thin(global_state):
        ...
        points[point_idx + 1] = {'start': [int(preds[4,0]), int(preds[4,1])],\
         'target': [int(preds[4,0])+15, int(preds[4,1])]}
        points[point_idx + 2] = {'start': [int(preds[12,0]), int(preds[12,1])],\
         'target': [int(preds[12,0])-15, int(preds[12,1])]}
    ...
    def on_click_closed(global_state):
        ...
        points[point_idx + 1] = {'start': [int(preds[37,0]), int(preds[37,1])],\
         'target': [int(preds[37,0])+10, int(preds[37,1])+10]}
        points[point_idx + 2] = {'start': [int(preds[40,0]), int(preds[40,1])],\
         'target': [int(preds[40,0])-10, int(preds[40,1])-10]}
        points[point_idx + 3] = {'start': [int(preds[43,0]), int(preds[43,1])],\
         'target': [int(preds[43,0])+10, int(preds[43,1])+10]}
        points[point_idx + 4] = {'start': [int(preds[46,0]), int(preds[46,1])],\
    ...
    closed_eye.click(on_click_closed, 
      inputs=[global_state],
      outputs=[global_state, form_image])

    def on_click_big(global_state):
        if global_state['editing_state'] != 'add_points':
            print(f'In {global_state["editing_state"]} state. '
                  'Do not add points.') 
            return global_state, global_state['images']['image_show']
        ...
        points[point_idx + 1] = {'start': [int(preds[38,0]), int(preds[38,1])],\
         'target': [int(preds[38,0])+10, int(preds[38,1])-10]}
        points[point_idx + 2] = {'start': [int(preds[37,0]), int(preds[37,1])],\
         'target': [int(preds[37,0])-10, int(preds[37,1])-10]}
        points[point_idx + 3] = {'start': [int(preds[40,0]), int(preds[40,1])],\
         'target': [int(preds[40,0])+10, int(preds[40,1])+10]}
        points[point_idx + 4] = {'start': [int(preds[43,0]), int(preds[43,1])],\
         'target': [int(preds[43,0])-10, int(preds[43,1])-10]}
        points[point_idx + 5] = {'start': [int(preds[44,0]), int(preds[44,1])],\
         'target': [int(preds[44,0])+10, int(preds[44,1])-10]}
        points[point_idx + 6] = {'start': [int(preds[41,0]), int(preds[41,1])],\
         'target': [int(preds[41,0])-10, int(preds[41,1])+10]}
        points[point_idx + 7] = {'start': [int(preds[46,0]), int(preds[46,1])],\
         'target': [int(preds[46,0])+10, int(preds[46,1])+10]}
        points[point_idx + 8] = {'start': [int(preds[47,0]), int(preds[47,1])],\
